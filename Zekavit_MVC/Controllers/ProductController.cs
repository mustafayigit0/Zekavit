...
namespace Zekavit_MVC.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public ProductController(Zekavit_MVCContext context,IFeatureService featureService,IProductService productService, IProductImageService productImageService,ICategoryService categoryService, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public async Task<IActionResult> CreateFeatures(FeatureListModel model, [FromRoute] int productId)
        {
            ...
            {
                FeatureDTO feautureDTO = new FeatureDTO();
